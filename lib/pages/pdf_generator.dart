        ...
        build: (context) => <Widget>[
              Header(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[Text('Portable Document Format', textScaleFactor: 2), PdfLogo()])),
              Paragraph(
                  text:
              ...
              Bullet(text: 'A subset of the PostScript page description programming language, for generating the layout and graphics.'),
              ...
              Paragraph(
                  text: 'A PDF file is often a combination of vector graphics, text, and bitmap graphics. The basic types of content in a PDF are:'),
...
var     teste = await getExternalStorageDirectories();
for (var dire in teste){
  print(dire);
}
print(teste);
  print('External');
//    print(await getExternalStorageDirectory()); // '/storage/emulated/0/Android/data/com.filipefonseca.flutter_tests/files'
  print('App Doc');
//    print(await getApplicationDocumentsDirectory()); // '/data/user/0/com.filipefonseca.flutter_tests/app_flutter'
  print('Temp');
//    print(await getTemporaryDirectory()); // '/data/user/0/com.filipefonseca.flutter_tests/cache'
    final String dir = (await getTemporaryDirectory()).path;
    final String path = join(dir, 'example.pdf');
